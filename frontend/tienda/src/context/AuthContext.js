...
export const AuthProvider = ({ children }) => {
    ...
    const login = async (email, password) => {
        try {
            const response = await axios.post('http://172.31.85.230:2000/api/users/login', { email, password });
    ...
    const register = async (username, email, password) => {
        try {
            const response = await axios.post('http://172.31.85.230:2000/api/users/register', { username, email, password });
    ...
    const loginWithAuth0 = async () => {
        window.location.href = 'http://172.31.85.230:2000/api/users/auth0-login';
    };
    ...
    const logout = async () => {
        try {
            ...
            await axios.post(
                'http://172.31.85.230:2000/api/users/logout',
                {},
